...
dependencies {
    val accompanisVersion= "0.37.3"
    implementation ("com.google.accompanist:accompanist-drawablepainter:$accompanisVersion")
    implementation( "com.google.accompanist:accompanist-permissions:$accompanisVersion")
    //room imports
